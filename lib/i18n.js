...
const I18N = {
  tr: {
    ...
    verificationLabel: "🔍 İkinci Görüş (Doğrulama)",
    confidenceHigh: "✅ Yüksek güven",
    confidenceMedium: "🟡 Orta güven",
    confidenceLow: "🔴 Düşük güven - dikkatli olun",

    historyBtn: "📜 Geçmiş",
    historyTitle: "📜 Analiz Geçmişi",
    noHistory: "Henüz analiz geçmişiniz yok.",
    viewProduct: "Ürüne Git",

    alternativesBtn: "🔎 Benzer Ürünleri Bul",
    alternativesTitle: "Benzer Ürünler",
    searchingAlternatives: "⏳ Aranıyor...",
    noAlternatives: "Benzer ürün bulunamadı.",

    bannerTaglineAmazon: "Kişisel AI alışveriş rehberin",
    bannerTaglineTrendyol: "Alışverişini senin için kolaylaştırır ✨",
    bannerTaglineHepsiburada: "Yapay zeka destekli alışveriş rehberin",
  ...
  en: {
    ...
    verificationLabel: "🔍 Second Opinion (Verification)",
    confidenceHigh: "✅ High confidence",
    confidenceMedium: "🟡 Medium confidence",
    confidenceLow: "🔴 Low confidence - be careful",
    ...
    alternativesBtn: "🔎 Find Similar Products",
    alternativesTitle: "Similar Products",
    searchingAlternatives: "⏳ Searching...",
    noAlternatives: "No similar products found.",

    bannerTaglineAmazon: "Your personal AI shopping guide",
    bannerTaglineTrendyol: "Makes your shopping easier ✨",
    bannerTaglineHepsiburada: "Your AI-powered shopping guide",
